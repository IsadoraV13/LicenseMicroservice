...
public class LicenseRepository {
    ...
    private List<License> createLicenseList() {
        ...
        License rollandGarros2023 = new License(1, start2023, end2023,
                tournamentRepo.findTournamentByName("RollandGarros2023"));
        License wimbledon2023 = new License(2, start2023, end2023,
                tournamentRepo.findTournamentByName("Wimbledon2023"));
        License wimbledonWomens2023 = new License(3, start2023, end2023, 2,
                tournamentRepo.findTournamentByName("Wimbledon2023"));
        License wimbledonMensFinal2023 = new License(4, start2024, end2024, 1,
                tournamentRepo.findTournamentByName("Wimbledon2023"));
        License matchofTheCentury2024 = new License(5, startTimeDay3_2024, endTimeDay3_2024, 3,
                tournamentRepo.findTournamentByName("Wimbledon2024"));
    ...
    public License findLicenseById(int licenseId) {
        ...
        License license = licenseRepo.getLicenseList().stream().filter(s -> s.getLicenseId() == licenseId).findAny().orElseThrow(
                () ->
